...
class SlackDirectoryLoader(BaseLoader):
    ...
    def __init__(self, zip_object: object, workspace_url: Optional[str] = None):
        """Initialize the SlackDirectoryLoader.

        Args:
            zip_object (object): The zip file object.
            *** deprecated ***
        ...
        self.channel_id_map = self._get_channel_id_map(self.zip_object)

    @staticmethod
    def _get_channel_id_map(zip_object: object) -> Dict[str, str]:
    ...
    def load(self) -> List[Document]:
        ...
        docs = []
        with zipfile.ZipFile(self.zip_object, "r") as zip_file:
